...
const CASE_STUDIES = [
  ...
  { num:"06",tag:"Brand refresh",title:"A brand new look — shaped by local talent",
    ...
    detail:"The ICO has introduced a refreshed look and feel, developed through a collaborative project with final year art and design students from University College Isle of Man. Wanting our identity to be shaped by the community we serve, we invited students to create logo concepts and visual ideas for a refreshed, engaging and collaborative ICO. The final design was inspired by a combination of these submissions, bringing together different creative elements into a single identity shaped by local talent.

The new look incorporates a triskelion formed from shapes inspired by the Manx hills, while the colour palette is drawn from Manx tartan. Together, these elements create a visual identity that feels both modern and rooted in the Island. ",
    bg:C.o,
