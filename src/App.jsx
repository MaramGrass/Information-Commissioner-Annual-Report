          ...
          <div style={{ display:"grid",gridTemplateColumns:m("1fr","clamp(280px,34vw,460px) 1fr"),height:"100%",overflow:"hidden" }}>
            ...
            <Reveal direction="right" style={{ display:"flex",flexDirection:"column",padding:m(0,"7vh 5vw 4vh"),overflow:"hidden" }}>
              ...
              <div ref={forewordScrollRef} style={{ fontSize:m(".82rem",".83rem"),color:C.mid,lineHeight:1.8,fontWeight:300,flex:m("none",1),minHeight:0,overflowY:m("visible","auto"),WebkitOverflowScrolling:"touch",overscrollBehavior:"contain",scrollbarWidth:"thin",scrollbarColor:`${C.t}55 transparent`,textAlign:m("left","justify"),hyphens:"auto",paddingRight:m(0,".75rem") }}>
                ...
                <p style={{ marginBottom:".65rem" }}>We have also listened. A survey of over 300 registered organisations shaped our strategy for 2026/27, <em>Compliance Through Collaboration</em>, built on the belief that compliance works best as a shared endeavour, with the regulator focused on prevention, partnership, and practical support rather than enforcement alone.</p>
