...
const CASE_STUDIES = [
  { num:"01",tag:"CCTV / Data breach",title:"Recording CCTV footage to a personal device",
    ...
    detail:"The Situation\n\nA large organisation reported a breach to the ICO in which a senior staff member used a personal mobile phone to record live security camera footage directly from the organisation’s monitor screens. The footage was then shared with someone who held no authorisation to receive it.\n\nThe investigation confirmed that the staff member was aware that their actions contravened data protection legislation at the time of the recording and was therefore intentional. CCTV footage of people constitutes personal data and its disclosure to an unauthorised third party without a lawful basis represents an unlawful processing of that personal data.\n\nThe organisation’s response\n\nThe organisation reported the incident to the ICO in line with its obligation to notify within 72 hours of becoming aware of a breach. The ICO’s investigation raised concerns not only about the individual’s conduct, but about whether the organisation’s data protection culture was being adequately upheld at a senior level.\n\nAssessment\n\nTwo distinct infringements were identified; the unauthorised recording of personal data onto an uncontrolled personal device, and the unlawful disclosure of that personal data to a third party. The staff member admitting awareness of misconduct at the time was an aggravating factor.\n\nThe seniority of the individual further heightened the severity of the incident. People occupying senior positions are typically entrusted with enhanced access to personal data and are therefore often ultimately responsible to ensure such data is processed and handled in accordance with the data protection legislation.\n\nThis case serves as an important reminder that a strong culture of data protection must be embedded and demonstrated from the top of the organisation. Compliance obligations apply equally regardless of seniority. Where leadership is seen to treat data protection as optional, it undermines the organisation’s culture of accountability for all staff.",
    bg:C.p,
  ...
  { num:"02",tag:"Data breach",title:"Confidential meeting ends up on social media",
    ...
    detail:"The Situation\n\nA member of the public shared a news article on social media and added a comment that included a screenshot of confidential information relating to one of the individuals featured in the article.\n\nOn its own, the screenshot did not directly identify the individual. However, when combined with the context provided in the article, it became possible to infer the identity of the person concerned.\n\nAn Island organisation recognised the information in the screenshot as a photograph of confidential notes taken during one of its internal meetings.\n\nAn internal investigation established that an employee had taken photographs of these notes using a personal mobile phone. The employee later confirmed that another member of their household had access to the device, and that information identifying the data subject may have been shared in a non-work group chat involving colleagues.\n\nThe organisation’s response\n\nThe organisation acted quickly once the issue was identified. The employee was suspended pending a full disciplinary review, and the organisation reported the breach to the Commissioner, providing all relevant findings to support the investigation.\n\nThe group chat in question was immediately cleared of data and closed after it was discovered that work-related information had been shared through it.\n\nThe organisation also conducted a thorough internal review to understand the extent of the breach. This included examining the employee’s level of access to confidential information, both digitally and in hard copy, and assessing whether any other unauthorised disclosure or extraction of personal data had taken place. Internal communication tools were reviewed, and policies were reinforced across the organisation.\n\nThe social media post was confirmed to have been removed, and the affected individual was notified of the breach. The organisation put measures in place to monitor any ongoing impact.\n\nAssessment\n\nThe breach arose primarily from the actions of the employee, who took a photograph of sensitive information using a personal device and thereby exposed it to processing outside of the organisation’s systems. This was particularly concerning given the employee’s awareness that the device was accessible to others.\n\nThe incident represented a failure to process personal data securely and was found to infringe Article 5(1)(f) of the Applied GDPR, which requires appropriate security of personal data.\n\nHowever, the organisation took immediate steps to contain the breach, cooperated fully with the ICO, and implemented improvements to its policies, procedures, and staff training. It also recognised its own responsibilities as a controller and took action to strengthen its approach to data protection.\n\nAs a result, the ICO was satisfied that appropriate remedial action had been taken and determined that no further regulatory action was necessary.\n\nLearning points\n\nEmployees should not use personal devices to store or process work-related information, particularly where it contains personal data. Organisations should ensure that staff have access to secure, approved tools, ensuring personal devices are not relied upon in the course of their work. Organisations have a responsibility to ensure appropriate technical and organisational measures are in place to protect personal data. Such measures can often be strengthened or improved even where a breach appears to be the result of an error or deliberate action by an individual employee.",
    bg:C.s,
  ...
  { num:"03",tag:"FOI — Food safety",title:"A proactive pivot: food inspection reports",
    ...
    detail:"The Situation\n\nIn March 2026, the Information Commissioner issued a decision notice to a public authority following a dispute over food inspection reports and associated photographs. The authority had applied a blanket exemption to the records, failing to evaluate how specific legal criteria applied to each individual document.\n\nAssessment\n\nIt was ruled that the authority must reprocess the request. Notably, the Information Commissioner observed that food safety is a topic of significant public interest and a frequent subject of FOI requests. In addition to reprocessing the data, the authority was encouraged to adopt a publication scheme to align with section 59 of the FOIA.\n\nLessons learned\n\nPublic authorities are encouraged to proactively publish frequently requested information. Adopting a formal publication scheme offers three primary benefits:\n\nReduced administrative burden: Making information publicly available allows staff to quickly redirect requesters to a link, rather than processing formal, time-consuming FOI requests.\n\nEnhanced accountability: Proactively publishing data sets, contracts, and salary scales demonstrates a commitment to transparency regarding spending and decision-making.\n\nEffective advice and assistance: A publication scheme serves as a roadmap, helping the public find information independently without navigating complex legal processes.\n\nAuthorities should regularly review their request logs to identify high-interest topics and consider it a matter of course to publish that information proactively.",
    bg:C.white,
  ...
  { num:"04",tag:"DPIA consultation",title:"Local processing, local context",
    ...
    detail:"The Situation\n\nA controller submitted a DPIA proposing new processing of personal data already held within their organisation and which they routinely collect. The proposal involved deploying a technology that, while widely used internationally, had not been previously implemented on the Isle of Man. The controller drew heavily on UK experience to justify its effectiveness and suitability.\n\nAssessment\n\nLooking to other jurisdictions for evidence and understanding is not inherently problematic. In fact, researching comparable use cases is an important part of demonstrating accountability. However, as an independent jurisdiction with a smaller population and distinct community expectations, the Isle of Man requires controllers to consider local context when introducing privacy-intrusive technologies. In this case the controller relied too heavily on the international/UK precedent without sufficiently addressing how the technology would operate within the Island’s close-knit environment.\n\nThe Information Commissioner would expect a DPIA to reflect this context, particularly where the processing is predominantly using Isle of Man resident data. Consideration of public engagement, communication strategies, and how individuals would be informed about the technology, its risks, and the safeguards in place can be vital. Such engagement is not only good practice but is also a means of building trust and demonstrating necessity and proportionality. If a controller chooses to not engage in such activities, robust justification would be expected.\n\nThe controller also attempted to adapt a publicly available DPIA from a UK organisation by replacing UK-specific elements with Isle of Man references. While using external templates as a starting point is acceptable, the final DPIA must accurately reflect the controller’s own processing and context. In this instance several UK-centric references remained, including links to privacy notices unrelated to the organisation or the Isle of Man. This undermined confidence in the controller’s understanding of their obligations and the robustness of their assessment.\n\nOn review, the ICO paused the consultation process and requested further information, along with a re-work of the DPIA. Several fundamental components of a DPIA were missing, including a complete risk assessment, supporting documentation referenced in the submission, and evidence of Senior Information Risk Owner (SIRO) and DPO input. There was also no indication of stakeholder engagement or justification for its absence.\n\nLessons learned\n\nThis case highlights that a DPIA is more than a procedural requirement — it is a controller’s opportunity to demonstrate understanding, accountability, and respect for the individuals whose data they process. Where a DPIA is subject to scrutiny, whether by the ICO or through other means, it must clearly articulate the nature of the processing, the personal data involved, and the safeguards and mitigations in place. A poorly constructed DPIA can erode trust, delay project timelines, increase costs, and heighten the risk of personal data breaches, with significant consequences for both organisations and the individuals affected.",
    bg:C.t,
  ...
  return (
    <div style={{
      ...
      <div key={`content-${csIdx}`} style={{
        ...
        {!mob && <p style={{ fontSize:"clamp(12px,1.4vh,15px)",color:C.mid,lineHeight:1.8,fontWeight:300,whiteSpace:"pre-wrap" }}>{study?.detail}</p>}
        ...
        <section id="foreword" style={{ ...P(C.paper), padding:m("8vw 5vw 6vw",0) }}>
          <div style={{ display:"grid",gridTemplateColumns:m("1fr","clamp(280px,34vw,460px) 1fr"),height:"100%",overflow:"hidden" }}>
            ...
            <Reveal direction="right" style={{ display:"flex",flexDirection:"column",padding:m(0,"7vh 5vw 4vh"),overflow:"hidden" }}>
              ...
              <div style={{ fontSize:m(".82rem",".83rem"),color:C.mid,lineHeight:1.8,fontWeight:300,flex:m("none",1),minHeight:0,overflowY:m("visible","auto"),scrollbarWidth:"thin",scrollbarColor:`${C.t}22 transparent`,textAlign:"justify",hyphens:"auto" }}>
                <p style={{ marginBottom:".65rem" }}>This has been a year of significant change for the Information Commissioner's Office. As technology advances and the ways in which data is processed become increasingly complex, the need for trusted, effective regulation has never been greater.</p>
                <p style={{ marginBottom:".65rem" }}>In response to growing regulatory demands, we have focused on strengthening our core capabilities, increasing our impact, and supporting both people and organisations across the Isle of Man.</p>
                <p style={{ marginBottom:".65rem" }}>Building on the progress made in 2024/25, our work has been guided by the five priority areas introduced in last year's annual report: Fixing our foundations, achieving financial independence, reducing backlogs of casework and streamlining how we process this work, educating and promoting compliance, and shaping the future of the office.</p>
                <p style={{ marginBottom:".65rem" }}>I am proud of the progress we have made over the past year in each of these areas. This includes growing our team and bringing in new skills and capabilities to support the delivery of our regulatory work.</p>
                <p style={{ marginBottom:".65rem" }}>The pace of change continues to accelerate, and we have played an active role in informing and contributing to policy development. We responded to consultations on Freedom of Information and the Data Assets Register, publishing our views to help inform wider discussion and decision-making.</p>
                <p style={{ marginBottom:".65rem" }}>We have also continued to modernise the office, updating both our registration system and internal technology, with further improvements already underway.</p>
                <p style={{ marginBottom:".65rem" }}>Another major milestone this year was the delivery of our fee consultation — an important step in supporting the office's long-term sustainability. We consulted on a proposed tiered, risk-based approach to registration fees linked to organisational employee headcount. Having carefully considered feedback from 81 respondents, our final recommendations include reduced upper-tier fees alongside a turnover-based provision.</p>
                <p style={{ marginBottom:".65rem" }}>Engagement has been a central theme throughout the year. We have taken a more proactive approach, delivering a wide range of speaking engagements and participating in national and international discussions, enabling us both to share our expertise and to learn from others.</p>
                <p style={{ marginBottom:".65rem" }}>International cooperation is both a legal obligation and a strategic necessity for a small island jurisdiction. Article 50 of the Applied GDPR formally requires us to engage with overseas counterparts — and rightly so, because data flows do not stop at borders.</p>
